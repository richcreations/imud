...
emits MAVLink — a HEARTBEAT plus ATTITUDE / ATTITUDE_QUATERNION — over UDP and/or
serial. It lets an autopilot or a ground station (QGroundControl, Mission Planner)
